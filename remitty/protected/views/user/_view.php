<div class="view">
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('status_msg')); ?>:
	<?php echo GxHtml::encode($data->status_msg); ?>
	<br />
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('contact_address')); ?>:
	<?php echo GxHtml::encode($data->contact_address); ?>
	<br />
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('tos')); ?>:
	<?php echo GxHtml::encode($data->tos); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('news_letters')); ?>:
	<?php echo GxHtml::encode($data->news_letters); ?>
	<br />
