...
class UserController extends GxController {
	...
	public function accessRules() {
		return array(
				...
				array('allow', // allow authenticated user to perform
						'actions'=>array( 'userFriends','logout', 'update','profile','changepassword','start','invite', 
	 ...
	 */
public function actionSignup($fb = 0,$signup_check = 0)
	{
		//var_dump($_POST);die;
		$arr = array('controller'=>$this->id , 'action'=>$this->action->id,'status'=>'NOK');
		$model = new User('create');
		/*$_POST['User']['email']='aditi.tuffgeekers@gmail.com';
		$_POST['User']['contact_no']='9876654';
		$_POST['User']['password']='123';
		$_POST['User']['full_name']='aditi';		$_POST['User']['gender']='1';*/
		if(isset($_POST['User']))
		{
			if($fb==0)
			{
				...
				if($signup_check == 0)
					$user = User::getUserByEmail( $_POST['User']['email']);
				else 
					$user = User::getUserByMobile(  $_POST['User']['contact_no']);
	...
	public function actionLogin()
	{
		...
		$model = new LoginForm;
		$json = array();
		//$_POST['LoginForm']['email']='aditi.tuffgeekers@gmail.com';
	
		//$_POST['LoginForm']['password']='123';
