...
class CreditCardController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'CreditCard');
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'credit-card-form');
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'CreditCard')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('CreditCard');
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['CreditCard']);
	...
	{	
		...
		if ( $model == null ) $model = new CreditCard();
