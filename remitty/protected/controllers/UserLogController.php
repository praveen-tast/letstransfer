...
class UserLogController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'UserLog');
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'user-log-form');

		if (isset($_POST['UserLog'])) {
			$model->setAttributes($_POST['UserLog']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'UserLog')->delete();
	...
	{	
		...
		if ( $model == null ) $model = new UserLog();
