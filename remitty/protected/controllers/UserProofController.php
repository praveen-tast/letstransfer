...
class UserProofController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'UserProof');
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'user-proof-form');

		if (isset($_POST['UserProof'])) {
			$model->setAttributes($_POST['UserProof']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'UserProof')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('UserProof');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['UserProof']))
		{
			$model->setAttributes($_GET['UserProof']);
	...
	{	
		...
		if ( $model == null ) $model = new UserProof();
