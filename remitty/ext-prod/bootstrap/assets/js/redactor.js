...
(function($){
	...
	Redactor.prototype = {
		...
		init: function()
		{
			...
			// contact_no
			if (this.opts.contact_no === false && this.iscontact_no())
			{
				this.build(true);
				return false;
			}
			...
			function afterBuild()
			{
				...
				if (this.iscontact_no(true) === false && oldsafari === false)
				{
		...
		build: function(contact_no, whendone)
		{
			if (contact_no !== true)
			{
				// container
		...
		showImage: function()
		{
			...
			var callback = $.proxy(function()
			{
				...
				if (this.opts.imageUpload !== false)
				{
					...
					// dragupload
					if (this.opts.uploadCrossDomain === false && this.iscontact_no() === false)
					{
